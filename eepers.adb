...
begin
    ...
    for Index in Footsteps_Range loop
        Footsteps_Sounds(Index) := Load_Sound(To_C("assets/sounds/footsteps.ogg"));
    ...
    Key_Pickup_Sound := Load_Sound(To_C("assets/sounds/key-pickup.ogg"));   -- https://opengameart.org/content/beep-tone-sound-sfx
    Ambient_Music := Load_Music_Stream(To_C("assets/sounds/ambient.ogg"));  -- https://opengameart.org/content/ambient-soundtrack
    ...
    Open_Door_Sound := Load_Sound(To_C("assets/sounds/open-door.ogg"));     -- https://opengameart.org/content/picked-coin-echo
    ...
    Plant_Bomb_Sound := Load_Sound(To_C("assets/sounds/plant-bomb.ogg"));   -- https://opengameart.org/content/ui-soundpack-by-m1chiboi-bleeps-and-clicks
